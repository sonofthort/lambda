...
var div = λ('a / b')
~~~
We've eliminated the argument naming duplication. After all, we could have just as well used *x* and *y* or *left* and *right* in our original functions. There's some overhead in creating the Function constructor, but the result is just as performant as the previous functions.

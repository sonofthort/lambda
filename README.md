...
~~~
A is a placeholder, a with toString() overloaded to return 'A', and the member 'push' returning 'A.push(...)' (... is whatever parameters are passed to it). Calling a placeholder has this effect:
~~~
A(a, b) // returns 'A(a, b)'
~~~
